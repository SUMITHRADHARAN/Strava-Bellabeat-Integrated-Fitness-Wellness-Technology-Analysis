...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/dailyActivity_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/dailyCalories_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/dailyIntensities_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/dailySteps_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/heartrate_seconds_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/hourlyCalories_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/hourlyIntensities_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/hourlySteps_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/minuteCaloriesNarrow_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/minuteCaloriesWide_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/minuteIntensitiesNarrow_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/minuteIntensitiesWide_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/minuteMETsNarrow_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/minuteSleep_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/minuteStepsNarrow_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/minuteStepsWide_merged.csv"
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/sleepDay_merged.csv"
INTO TABLE sleepday
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE "C:/Users/dhara/Documents/Interns/Labmentix/6. Starva Fitness/Data Files/weightLogInfo_merged.csv"
...
# Data Validation
SELECT 
    MIN(avg_heart_rate) AS min_hr, 
    MAX(avg_heart_rate) AS max_hr,
    MIN(BMI) AS min_bmi, 
    MAX(BMI) AS max_bmi
FROM starva.stravafullmergeddata;
...
SELECT ActivityDate FROM dailyactivity;

-- Max Distance By Max Active Distance
SELECT id, max(TotalDistance) AS TopDistance, 
max(VeryActiveDistance) AS TopActiveDistance
FROM DailyActivity 
GROUP BY id
ORDER BY TopDistance DESC;

-- Top Active Minutes By Calories
SELECT id, max(VeryActiveDistance) AS TopActiveMinutes,
max(TrackerDistance) AS MaxTrackerDistance, Calories
FROM DailyActivity
GROUP BY id, Calories
ORDER BY MaxTrackerDistance DESC, Calories DESC LIMIT 5;

-- Activity Date by Topsteps, TopDistance And Calories
SELECT id, ActivityDate, max(TotalSteps) AS TopSteps, max(TotalDistance) AS TopDistance, 
Calories
FROM DailyActivity
GROUP BY id, ActivityDate, Calories
ORDER BY TopSteps DESC, TopDistance DESC, Calories DESC
LIMIT 10;

-- 2. Daily Calories Table 
SELECT * FROM dailycalories;

-- AvgCalories 
SELECT ActivityDay, avg(Calories) AS AvgCalories 
FROM dailycalories 
GROUP BY ActivityDay;

-- Inner join Daily Activity by total steps
SELECT a.id, a.ActivityDate, a.TotalSteps, c.Calories 
FROM dailyactivity a INNER JOIN dailycalories c ON a.id = c.id;

-- Daily Activity Date by Daily Calories (using Window Function)
SELECT ActivityDate, TotalDistance AS MaxDistance, Calories 
FROM (
    SELECT a.ActivityDate, a.TotalDistance, c.Calories,
    row_number() OVER (PARTITION BY a.ActivityDate ORDER BY a.TotalDistance DESC) AS Activity
    FROM dailyactivity a 
    INNER JOIN dailycalories c ON a.id = c.id
) sub
...
SELECT 
min(TotalDistance), max(TotalDistance), min(TotalSteps), max(TotalSteps),
min(LoggedActivitiesDistance), max(LoggedActivitiesDistance), min(SedentaryActiveDistance),
max(SedentaryActiveDistance),
min(SedentaryMinutes), max(SedentaryMinutes),
min(Calories), max(Calories)
FROM dailyactivity;

-- Checking SedentaryMinutes by Daily Patterns 
SELECT id, SedentaryMinutes, count(*) AS 'Sedentary Days (=> 1440 mins)'
FROM dailyactivity
...
-- Avg Sleep Minutes By Id
SELECT id, avg(TotalMinutesAsleep) AS AvgSleepMinutes 
FROM sleepday
GROUP BY id;

-- Sleepday Records more than 2 
SELECT id, TotalSleepRecords, count(*) AS MoreSleepRecords
FROM sleepday
WHERE TotalSleepRecords >= 2
GROUP BY id, TotalSleepRecords 
ORDER BY TotalSleepRecords DESC;

-- Max Asleep, BedTime by MoreSleepRecords
SELECT id, 
max(TotalMinutesAsleep) AS MoreAsleep, 
max(TotalTimeInBed) AS MoreBedTime,
max(TotalSleepRecords) AS MoreSleep
FROM sleepday
GROUP BY id
ORDER BY MoreSleep DESC;

-- 4. Dailysteps
SELECT * FROM dailysteps;

-- Sum Steps By Activity Day 
SELECT ActivityDay, sum(StepTotal) AS TotalSteps
FROM dailysteps
GROUP BY ActivityDay;

-- AvgSteps By Id
SELECT id, avg(StepTotal) AS AvgSteps 
FROM dailysteps
GROUP BY id;
...
-- Avg Steps BY ActivityHour
SELECT ActivityHour, avg(StepTotal) AS AvgSteps
FROM hourlysteps
GROUP BY ActivityHour;

-- Records where StepTotal is 0 
SELECT id, ActivityHour, StepTotal
FROM hourlysteps
WHERE StepTotal = 0
GROUP BY Id, ActivityHour;

-- MaxSteps By ActivityHour Top 10 results 
SELECT ActivityHour, max(StepTotal) AS MaxSteps
FROM hourlysteps
GROUP BY ActivityHour
...
-- AvgCalories by ActivityHour
SELECT ActivityHour, avg(Calories) AS AvgCalories
FROM hourlycalories
GROUP BY ActivityHour
ORDER BY AvgCalories DESC;

-- Top 10 Id by Max Calories
SELECT id, max(Calories) AS MaxCalories 
FROM hourlycalories
GROUP BY id 
...
-- AvgIntensity by Hour 
SELECT hour(ActivityHour) AS Hr, avg(TotalIntensity) AS AvgIntensity
FROM hourlyintensities
GROUP BY Hr
ORDER BY Hr DESC;

-- MaxIntensity by ActivityHour
SELECT ActivityHour, max(TotalIntensity) AS MaxIntensity
FROM hourlyintensities
GROUP BY ActivityHour
...
-- Values By Minute 
SELECT minute(date) AS Minutesleep, value
FROM minutesleep
GROUP BY minute(date), value
ORDER BY value DESC;

-- Minute Sleep Where Value is 3
SELECT minute(date) AS Minutesleep, value
FROM minutesleep 
WHERE value = 3 
...
-- Avg Heart Rate By Id
SELECT id, avg(Value) AS AvgHeartRate
FROM heartrateseconds
GROUP BY Id;


-- Max Heart Rate by Time (Hr, Minute, Seconds)
SELECT max(Value) AS MaxHeartRate, Hour(Time) AS Hr,
minute(Time) AS Minute, second(Time) AS Seconds
FROM heartrateseconds
GROUP BY Time
ORDER BY MaxHeartRate DESC;

-- 10. Minute Calories 
-- AvgCalories by ActivityMinute
SELECT ActivityMinute, avg(Calories) AS AvgCalories
FROM minutecaloriesnarrow
GROUP BY ActivityMinute;

-- MaxCalories by Minute
SELECT minute(ActivityMinute) AS Minute, max(Calories) AS MaxCalories
FROM minuteCaloriesnarrow
GROUP BY minute(ActivityMinute)
ORDER BY MaxCalories DESC;

-- Min Calories by Minute
SELECT minute(ActivityMinute) AS Minute, min(Calories) AS MinCalories
FROM minuteCaloriesnarrow
GROUP BY minute(ActivityMinute)
ORDER BY MinCalories DESC;

-- Top 10 ActivityMinute by TotalCalories
SELECT hour(ActivityMinute) AS Hr, 
minute(ActivityMinute) AS Minute,
second(ActivityMinute) AS Seconds,
...
-- AvgWeightKg by AvgBMI
SELECT avg(WeightKg) AS AvgKg, avg(BMI) AS AvgBMI
FROM weightloginfo;

-- IsManualReport By AvgWeightKg and AvgBMI
SELECT IsManualReport, avg(WeightKg) AS AvgKg, avg(BMI) AS AvgBMI, count(*) AS Count
FROM weightloginfo
GROUP BY IsManualReport
ORDER BY AvgKg DESC;

-- =============================================
-- SUMMARY DASHBOARD (RECORDS TOTAL)
-- =============================================
SELECT 
(SELECT avg(TotalDistance) FROM dailyactivity) AS AvgDistance,
(SELECT avg(VeryActiveDistance) FROM dailyactivity) AS VeryActiveDistance,
(SELECT avg(Calories) FROM dailycalories) AS DailyCalories,
(SELECT avg(StepTotal) FROM dailysteps) AS DailySteps,
(SELECT avg(Calories) FROM hourlycalories) AS Hourlycalories,
(SELECT avg(TotalIntensity) FROM hourlyintensities) AS Hourlyintensities,
(SELECT avg(TotalSleepRecords) FROM sleepday) AS SleepRecord,
(SELECT avg(WeightKg) FROM weightloginfo) AS WeightKg,
(SELECT avg(BMI) FROM weightloginfo) AS BMI,
(SELECT AVG(Value) FROM heartrateseconds) AS HeartRate;
